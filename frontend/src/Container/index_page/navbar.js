...
const items = [
    { key: "home", label: _jsx(Link, { to: "/", children: "\u0E2B\u0E19\u0E49\u0E32\u0E41\u0E23\u0E01" }) },
...
const HomePage = () => {
    return (_jsxs(Header, { style: {
            ...
            padding: "0 40px",
                    ...
                    flex: 1,
                }, items: items }), _jsxs("div", { style: { color: "#722ED1", fontWeight: 600, cursor: "pointer" }, children: [_jsx(UserOutlined, { style: { marginRight: 6 } }), _jsx(Link, { to: "/login", children: "\u0E25\u0E07\u0E0A\u0E37\u0E48\u0E2D\u0E40\u0E02\u0E49\u0E32\u0E43\u0E0A\u0E49" })] })] }));
};
