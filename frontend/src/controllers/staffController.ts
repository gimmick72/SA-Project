...
import type { PersonalData, Department } from '../pages/staff_info/types';
import type { Staff } from '../pages/staff_info/index'; // import type Staff
import { message } from 'antd';

const API_BASE = 'http://localhost:8080';

export const StaffController = {
    getAllStaff: async (): Promise<Staff[]> => {  // ✅ เปลี่ยน type เป็น Staff[]
        try {
    ...
    addStaff: async (department: Department, personalData: PersonalData) => {
        try {
