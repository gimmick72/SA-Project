...
const ActionButtonPayment: React.FC = ({ }) => {
    return (
        <div style={{ border: '2px none #000000', height: '205px', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 20, padding: '0 16px' }}>
            <div style={{ display: 'flex', flexDirection: 'column',justifyContent: 'center', alignItems: 'center', width: '100%',gap: '20px' }}>
                ...
                <Button type="primary" style={{ width: '100%', height: 40 }}>ชำระเงิน</Button>
            </div>
