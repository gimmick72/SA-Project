...
const Promotion = () => {
    ...
    return (
        <div style={{ maxWidth: '100%', height:500, margin: '0 auto 0 auto', display: 'flex', flexDirection: 'column', gap: '20px', boxSizing: 'border-box', position: 'relative', background: '#fff' }}>
