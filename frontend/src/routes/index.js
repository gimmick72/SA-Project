...
const ProtectedRoute = ({ children }) => {
    ...
    return isAuthenticated ? _jsx(_Fragment, { children: children }) : _jsx(Navigate, { to: "/auth/login", replace: true });
};
function ConfigRoutes() {
    ...
    const protectedStaffRoutes = StaffRoutes.map(route => (Object.assign(Object.assign({}, route), { element: _jsx(ProtectedRoute, { children: route.element }) })));
    // Combine all routes
    const routes = [
        ...HomeRoutes,
        ...authRoutes,
